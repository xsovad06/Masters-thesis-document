...
\TABULKA[][tab:evaluation-unified]{Evaulation Statistics for the Unified Format}
    ...
    \bTR
        \bTD Total Mean Squared Error (MSE):             \eTD\bTD    813.37 \eTD\bTD     \eTD\eTR
    \bTR
        \bTD Total Object Kepoint Similarity (OSK):      \eTD\bTD    0.2 \eTD\bTD    \eTD\eTR
    \bTR
...
\TABULKA[][tab:evaluation-mmpose]{Evaulation Statistics for the MMPose model}
    ...
    \bTR
        \bTD Total Mean Squared Error (MSE):             \eTD\bTD    70.8 \eTD\bTD     \eTD\eTR
    \bTR
        \bTD Total Object Kepoint Similarity (OSK):      \eTD\bTD    0.2 \eTD\bTD    \eTD\eTR
    \bTR
