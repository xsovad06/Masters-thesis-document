...
% ------- Sub-section ------- %
\pkap[subsection:oks]{Object Keypoint Similarity}
...
% ------- Sub-section ------- %
\ppkap[subsection:ape-mse-oks]{Combining APE, MSE, and OKS}
...
Lastly, the chapter delves into the evaluation metrics employed to assess the performance of pose estimation models (\in{Section}[section:metrics]). Metrics such as {\bf APE}, {\bf MSE}, and {\bf OKS} are explained, along with their significance in gauging the accuracy and efficacy of detection algorithms.
