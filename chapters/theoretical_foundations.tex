...
\TABULKA[][tab:posenet-features]{Posenet model features}
    ...
    \bTR
        \bTD Landmarks\eTD\bTD	33 keypoints on each person\eTD\eTR
    \bTR
...
\obrazek{posenet-skeleton}{Posenet skeleton structure with IDs to each keypoint. The skeleton representation plays a crucial role in introducing the unified format as described in \\in{section}[section:unified-format] on \\at{page}[section:unified-format]. Source: (\\scc GoogleAI, 2024).}{figures/posenet-detection-structure.png}{width=\makeupwidth}
